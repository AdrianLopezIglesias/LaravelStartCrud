...
driver.get(URLS)
driver.find_element_by_xpath('//*[@id="link_navbar_tratamientos"]').click()
driver.find_element_by_xpath('//*[@id="boton_tratamiento_abrir_form"]').click()

time.sleep(1)
name = fake.catch_phrase()
descripcion = fake.paragraph(nb_sentences=5)
descripcion_corta = fake.paragraph(nb_sentences=3)
sesiones = fake.random_int(0, 10)*4
valor = fake.random_int(1, 10)*sesiones*1500

driver.find_element_by_xpath('//*[@id="nombre"]').send_keys(name)
driver.find_element_by_xpath('//*[@id="descripcion"]').send_keys(descripcion)
driver.find_element_by_xpath('//*[@id="descripcion_corta"]').send_keys(descripcion_corta)
driver.find_element_by_xpath('//*[@id="sesiones"]').send_keys(sesiones)
driver.find_element_by_xpath('//*[@id="valor"]').send_keys(valor)

driver.find_element_by_xpath('//*[@id="boton_tratamiento_store"]').click()
...
driver.find_element_by_xpath('//*[@id="load-div-button"]').click()
